...
namespace CollectionsService.Data
{
    public interface ICollectionsServiceContext
    {
    ...
    public class CollectionsServiceContext: DbContext, ICollectionsServiceContext
    {
        public CollectionsServiceContext()
            :base("CollectionsServiceContext")
        {
